...
(defun findNodesOnLevel (tree k stack currentLevel)
    (cond
        ...
        ((and (= k currentLevel) (= (cadr tree) 0)) (myAppend (list (car tree)) (findNodesOnLevel (myAppend (list (car stack) (- (cadr stack)) 1) (cddr tree)) k (cddr stack) (- currentLevel 1))))
